...
const ProfileCard = () => {
	...
	return (
		<div className="relative w-[28rem] h-[20rem] p-6">
			<div
			...
			>
				<div className="flex-1 p-8 flex flex-col justify-between">
					<div className="flex flex-col items-start gap-1 ">
						<CodeIcon size={24} className="text-black dark:text-white" />
						<div>
							<h2 className="text-black dark:text-white text-2xl font-semibold">Kanak Kumar</h2>
							<p className="text-neutral-600 dark:text-white/70 text-lg">Design Engineer</p>
						</div>
					</div>

					<div className="text-neutral-600 dark:text-white/60 text-sm leading-relaxed">
							...
							{isHovered ? (
								...
								>
									<div className="flex border border-black/20 dark:border-white/20 rounded-full overflow-hidden">
										<button className="bg-white cursor-pointer text-black px-4 py-0 font-medium hover:bg-white/90 transition-all duration-200">
											Hire Me
										</button>
										<button className="dark:bg-white/10 bg-black/5 backdrop-blur-sm cursor-pointer text-black dark:text-white px-4 py-0 font-medium hover:bg-black/10 dark:hover:bg-white/20 transition-all duration-200 flex items-center gap-2">
											<MailIcon size={16} />
										</button>
									</div>
								</motion.div>
								...
								<motion.div
									...
									exit={{ opacity: 0, y: -20 }}
									transition={{ duration: 0.3, ease: "easeInOut" }}
									className="absolute inset-0 flex items-center text-neutral-600 dark:text-white/70 text-sm"
								>
									Hope you have a{" "}
				...
				<div className="w-32 p-4 flex flex-col items-center justify-between">
					<div className="dark:bg-white/10 bg-black/5 backdrop-blur-md border dark:border-white/20 border-black/10 w-full h-full rounded-full flex flex-col items-center justify-between p-4">
						<div className="relative -mt-2">
							<div className="w-20 h-20 rounded-full border-2 dark:border-white/30 border-black/20 overflow-hidden dark:bg-white/20 bg-black/10 backdrop-blur-sm">
								<Image

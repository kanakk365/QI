...
export const infiniteScrollComponent: ComponentData = {
  name: "Infinite Scroll",
  description: "A smooth infinite scrolling component with animated content and hover interactions.",
  preview: () => import("@/src/registry/default/ui/InfiniteScroll"),
  demo: `"use client";
...
export default InfiniteScroll;`,
      language: "tsx",
      filename: "components/ui/InfiniteScroll.tsx"
    }
  ]
}; 
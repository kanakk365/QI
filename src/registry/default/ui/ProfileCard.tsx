      ...
      >
        <div className="flex-1 p-6 sm:p-8 flex flex-col justify-between">
          <div className="flex flex-col items-start gap-1 ">
            ...
            <div>
              <h2 className="text-black dark:text-white text-xl sm:text-2xl font-semibold">
                Kanak Kumar
              </h2>
              <p className="text-neutral-600 dark:text-white/70 text-sm sm:text-lg">
                Design Engineer
              </p>
            </div>
          </div>
          ...
          <div className="text-neutral-600 dark:text-white/60 text-xs sm:text-sm leading-relaxed">
            Passionate about{" "}
            <span className="text-black dark:text-white">design</span>, but I
            truly excel at{" "}

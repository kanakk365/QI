...
export const calendarComponent: ComponentData = {
  ...
  preview: () => import("@/components/ui/Calendar"),
  demo: `import { FullScreenCalendar } from "@/components/ui/Calendar"
...
import { Separator } from "@/components/appui/separator"
...
export function FullScreenCalendar({ data }: FullScreenCalendarProps) {
  ...
  return (
    ...
    },
    {
      ...
      code: `import { FullScreenCalendar } from "@/components/ui/Calendar"

...
export default function Graph() {
  ...
  return (
    <div className="bg-card rounded-xl shadow-[0_2px_4px_rgba(0,0,0,0.1),0_4px_8px_rgba(0,0,0,0.05),0_8px_16px_rgba(0,0,0,0.02)] dark:shadow-[0_2px_4px_rgba(255,255,255,0.1),0_4px_8px_rgba(255,255,255,0.05),0_8px_16px_rgba(255,255,255,0.02)] border border-border p-4 font-inter">
      <motion.div
        className=" w-[21rem] "
      ...
      >
        <div className="">
          ...
          <p className="text-muted-foreground text-sm font-inter">
            Interactive data visualization to track revenue trends and forecast
            future projections
          </p>
        </div>
        <svg
          height="300"
          viewBox="50 0 2000 1400"
